    ...
    return (
        <div>
            ...
            <div className="profileHeader">
                ...
                <div style={{display: "flex", alignItems: "center", paddingBottom: 10}}>
                    ...
                    <StarRatings
                        ...
                        starSpacing={"3px"}
                    />
                    <div style={{marginLeft: 5}}>({airlineDetails?.ranking})</div>
                </div>
            </div>
            ...
            <div style={{display: "flex", justifyContent: "center", width: "100%", paddingBottom: 20}}>
                <button style={{fontSize: 14}} className="blueButton" onClick={() => setIsNewReviewModalOpen(true)}>Write a review</button>
            </div>
        </div>
    );
};
